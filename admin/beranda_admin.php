...
Halo, <strong class="text-yellow-700"><?php echo $_SESSION['username']; ?></strong>! Apa kabar? 😊
</div>
<p class="text-sm text-grey-700">Silakan gunakan menu di samping untuk mengelola data.</p>
