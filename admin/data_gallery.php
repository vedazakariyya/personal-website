...
<body class="bg-yellow-100 min-h-screen">
  <!-- Header -->
  <header class="bg-yellow-700 text-white text-center py-6 shadow">
    <h1 class="text-3xl font-bold">Kelola Gallery</h1>
  </header>
  <div class="flex max-w-7xl mx-auto mt-8 px-4">
    <!-- Sidebar -->
    <aside class="w-1/4 bg-white rounded shadow p-4">
      <h2 class="text-xl font-semibold text-yellow-700 mb-4 text-center">MENU</h2>
      <ul class="space-y-2 text-gray-700">
        <li><a href="beranda_admin.php" class="block hover:text-yellow-600">Beranda</a></li>
        <li><a href="data_artikel.php" class="block hover:text-yellow-600">Kelola Artikel</a></li>
        <li><a href="data_gallery.php" class="block font-semibold text-yellow-800">Kelola Gallery</a></li>
        <li><a href="about.php" class="block hover:text-yellow-600">About</a></li>
        <li>
    ...
    <main class="w-3/4 bg-white rounded shadow p-6 ml-6">
      <div class="flex justify-between items-center mb-4">
        <h2 class="text-xl font-bold text-yello-700">Daftar Gallery</h2>
        <a href="add_gallery.php"
          class="bg-yellow-500 text-white px-4 py-2 rounded hover:bg-yellow-700 transition">+ Tambah Gambar</a>
      </div>
  ...
  <!-- Footer -->
  <footer class="bg-yellow-700 text-white text-center py-4 mt-10">
