...
<li><a href="data_artikel.php" class="block font-semibold text-yellow-800">Kelola Artikel</a></li>
<li><a href="data_gallery.php" class="block hover:text-yellow-600">Kelola Gallery</a></li>
...
class="bg-yellow-600 text-white px-4 py-2 rounded hover:bg-yellow-700 transition">+ Tambah Artikel</a>
</div>
